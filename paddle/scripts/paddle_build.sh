...
set +x
        ...
        echo "exclusive_tests_high_parallel: $exclusive_tests_high_parallel"
        echo "exclusive_tests_two_parallel: $exclusive_tests_two_parallel"
        ...
        card_test "$multiple_card_tests_two_parallel" 2 8       # run cases 2 job each time with two GPUs
        ...
        card_test "$exclusive_tests_high_parallel" -1 8
        card_test "$exclusive_tests_two_parallel" -1 4         # run cases exclusively, in this cases would be run with 2/4/8 GPUs
